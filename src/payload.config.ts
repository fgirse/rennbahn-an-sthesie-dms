...
import { Documents } from './collections/Documents/index.ts'
import { Media } from './collections/Media/index.ts'
import { AuditLogs } from './collections/AuditLogs/index.ts'
import { ReadConfirmations } from './collections/ReadConfirmations/index.ts'
import { ApprovalTasks } from './collections/ApprovalTasks/index.ts'
import { Notifications } from './collections/Notifications/index.ts'
import { DocumentCategories } from './collections/DocumentCategories/index.ts'
import { SiteSettings } from './globals/SiteSettings/index.ts'
